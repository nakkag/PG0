...
#define WM_SET_HIGHLIGHT_LINE			(WM_APP + 8)
#define WM_SET_ERROR_LINE				(WM_APP + 9)
#define WM_SET_EXTENSION				(WM_APP + 10)
#define WM_FINDTEXT						(WM_APP + 11)
#define WM_SHOW_LINE_NO					(WM_APP + 12)
